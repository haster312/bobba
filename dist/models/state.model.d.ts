...
export declare const StateModel: import("mongoose").Schema<State, import("mongoose").Model<State, any, any, any, import("mongoose").Document<unknown, any, State> & State & Required<{
    _id: string;
